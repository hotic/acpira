...
- `pnpm catalog:update` — regenerate the built-in model catalogue `rust/crates/acpira-host/assets/model-catalog.json` from models.dev (`acpira model-catalog [--out FILE]`); refresh before a release
