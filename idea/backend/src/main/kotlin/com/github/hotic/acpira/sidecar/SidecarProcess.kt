...
// One sidecar process (the Rust binary): ndjson envelopes on stdout (one JsonObject per line; anything else is logged and skipped), the sidecar's
...
class SidecarProcess(
    ...
    init {
        ...
        pb.environment().putAll(ShellEnv.map())
