...
export const en = {
  ...
  'quota.window.weeklyOpus': 'Weekly Opus',
  ...
  'turns.compacted': 'Compacted context',
  ...
  'host.retrying': 'Model request failed; retrying in {seconds}s (attempt {attempt}/{max})',
  'host.retryingBare': 'Model request failed; retrying…',
  'host.retryFinished': 'Resumed after retry {attempt}',
  'host.retryFinishedBare': 'Retry finished; resuming',
  ...
  'host.accountSwitched': '{from} ran out of quota; switched to {to} and continued',
  'host.autoContinuePrompt': 'The previous turn was cut off because the account ran out of quota, and this session has moved to another account. Continue the unfinished task from where it stopped; do not repeat steps that are already done.',
  'host.sidecarFailed': 'The Acpira host process stopped: {detail}',
  'host.sidecarRetry': 'Retry',
  'host.showLog': 'Show Log',
  ...
  'export.label.autoContinue': 'Continued automatically after an account switch',
  ...
  'settings.accountSwitch': 'Switch when quota runs out',
  'settings.accountSwitch.desc': 'When the bound account runs out of quota mid-task, move the session to another saved account of the same agent and continue automatically.',
  'settings.accountSwitch.earliestReset': 'Earliest reset first',
  'settings.accountSwitch.mostRemaining': 'Most quota left',
  'settings.accountSwitch.listOrder': 'List order',
  'settings.accountSwitch.off': 'Don\'t switch',
