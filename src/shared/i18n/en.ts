...
export const en = {
  ...
  'settings.accountSwitch.desc': 'When the bound account runs out of quota mid-task, move the session to another saved account and continue automatically.',
  ...
  'settings.accountSwitch.off': 'Off',
