...
export const en = {
  ...
  'subagents.tabs.tree': 'Relations',
  'subagents.tabs.info': 'Info',
  ...
  'subagents.observedOnly': 'Controlled by the parent agent; process view only.',
  'subagents.noCancel': 'This child declared no cancel control.',
  'subagents.receiptOnly': 'This agent only reports the delegation and its result; there is no separate process stream.',
  'subagents.nestedNote': 'The parent forwards this child’s tool calls; its own reply arrives as a summary when it finishes.',
  ...
  'subagents.info.state': 'State',
  'subagents.info.role': 'Role',
  'subagents.info.model': 'Model',
  'subagents.info.visibility': 'Visibility',
  'subagents.info.elapsed': 'Observed for',
  'subagents.info.tools': 'Tool calls',
  'subagents.info.background': 'Background',
  'subagents.info.cancelable': 'Cancelable',
  'subagents.info.context': 'Context',
  'subagents.info.peer': 'Upstream ids',
  'subagents.visibility.session': 'Own session stream',
  'subagents.visibility.sessionHint': 'The agent streams this child’s messages and tools under its own session id.',
  'subagents.visibility.nested': 'Forwarded by the parent',
  'subagents.visibility.nestedHint': 'Tool calls arrive on the parent session with a structured parent link.',
  'subagents.visibility.receipt': 'Delegation receipt',
  'subagents.visibility.receiptHint': 'Only the delegation call and its result are visible.',
