...
export const zhCN = {
  ...
  'usage.historyEstimate': '聊天记录估算',
  'usage.historyEstimateHint': '全部聊天记录的估算，不代表模型当前上下文。',
  ...
  'subagents.tabs.tree': '关系',
  'subagents.tabs.info': '信息',
  ...
  'subagents.observedOnly': '由父代理控制，仅查看过程。',
  'subagents.noCancel': '此子代理未声明独立取消能力。',
  'subagents.receiptOnly': '此代理只提供委派回执和结果，没有独立的过程流。',
  'subagents.nestedNote': '父代理转发该子代理的工具调用；它自己的回复在结束时以摘要给出。',
  ...
  'subagents.info.state': '状态',
  'subagents.info.role': '角色',
  'subagents.info.model': '模型',
  'subagents.info.visibility': '可见性',
  'subagents.info.elapsed': '观察用时',
  'subagents.info.tools': '工具调用',
  'subagents.info.background': '后台',
  'subagents.info.cancelable': '可取消',
  'subagents.info.context': '上下文',
  'subagents.info.peer': '上游标识',
  'subagents.visibility.session': '独立子会话流',
  'subagents.visibility.sessionHint': '代理以独立会话 id 流出该子代理的消息与工具。',
  'subagents.visibility.nested': '父会话转发',
  'subagents.visibility.nestedHint': '工具调用带结构化父级标识到达父会话。',
  'subagents.visibility.receipt': '仅委派回执',
  'subagents.visibility.receiptHint': '只能看到委派调用与其结果。',
